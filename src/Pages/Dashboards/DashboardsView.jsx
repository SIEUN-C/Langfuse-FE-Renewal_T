...
export const DashboardsView = () => {
  ...
  const columns = [
    ...
    {
      header: "Created At",
      accessor: (row) => dashboardUtils.formatDate(row.createdAt), // formatDate → dashboardUtils.formatDate
    },
    {
      header: (
        <div
      ...
      accessor: (row) => dashboardUtils.formatDate(row.updatedAt), // formatDate → dashboardUtils.formatDate
    },
    {
      header: "Actions",
      accessor: (row) => (
