...
import { WidgetsAPI } from './services/widgetsAPI.js';
...
export const SelectWidgetDialog = ({
  ...
  // 새 위젯 생성 페이지로 이동 (나중에 위젯팀 라우트로 교체)
  const handleCreateNewWidget = () => {
    // TODO: 위젯팀 구현 완료 후 실제 라우팅으로 교체
    // navigate(`/project/${projectId}/widgets/new?dashboardId=${dashboardId}`);
    
    alert('위젯 생성 페이지로 이동 (위젯팀 라우팅 연결 대기 중)');
    console.log('Navigate to:', `/project/${projectId}/widgets/new?dashboardId=${dashboardId}`);
  };
